...
function _stattic_runtime_job_maintenance_tick(string $privateRoot, array $claims = []): array
{
    ...
    // cron/CLI entry into the tick does not go through management.php. Without
    // these the function_exists guards below silently skip real work.
...
{
    if (!function_exists('_stattic_runtime_route_shard_gc')) {
        return;
    }
