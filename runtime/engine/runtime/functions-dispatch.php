...
function _stattic_functions_dispatch(
    ...
    // private space's Functions responses would be shared-cacheable by worker
    // fiat. A public space keeps worker-declared caching: `public` is null.
    $cachePolicy = _stattic_cache_policy(['private' => $privateCache, 'public' => null]);
    ...
    $request = [
        ...
        'sink' => 'output',
        'on_headers' => static function (int $responseStatus, array $headerPairs) use (&$status, &$headersSent, $cachePolicy, $insertSnippets): void {
