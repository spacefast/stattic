...
// but could not be read or decoded this instant. Callers that only check
// is_array() are unchanged; callers on destructive/index-write paths MUST
// treat false as "abort", never as "absent". (No runtime document is the bare
// JSON literal `false`, so the sentinel is unambiguous.)
