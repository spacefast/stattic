...
test("canonical admission is private by default, host-bound, and neutralizes publisher headers", async () => {
  ...
  // A Link targeting all Versions has one stable URL on the live hostname.
  // The same authority must therefore admit both that URL and immutable Version hosts.
